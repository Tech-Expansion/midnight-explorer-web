...
export const networkAPI = {
  ...
  /**
   * Get 1 day network statistics with success/failed breakdown
   */
  getStats1Day: <T = unknown>() =>
    apiFetch<T>('/network/stats1day'),

  /**
   * Get 7 days chart data with success/failed breakdown
   */
  getChart7Day: <T = unknown>() =>
    apiFetch<T>('/network/chart7Day'),

  /**
   * Get 1 month chart data with success/failed breakdown
   */
  getChart1Month: <T = unknown>() =>
    apiFetch<T>('/network/chart1Month')
}
